...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    /*stores the resource id for background  colors of each category*/
     ...
     */
    public WordAdapter(Activity context, ArrayList<Word> word, int colors) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // Find the TextView in the list_item.xml layout with the ID miwork_word
        TextView miworkWord = (TextView) listItemView.findViewById(R.id.miwork_word);
        // Get the miwork word from the current AndroidFlavor object and
        ...
        int color = ContextCompat.getColor(getContext(), mColorCategory);
